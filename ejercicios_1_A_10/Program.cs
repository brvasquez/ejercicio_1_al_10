...

	{
        ...
        static void Main(string[] args)
		{
			...
			do
			{
				...
				Console.WriteLine("1.Definir si es par o impar ");
				Console.WriteLine("2.Mostrar la tabla de multiplicar del número ingresado ");
				Console.WriteLine("3.Tablas de multiplicar del 2 al 9");
				Console.WriteLine("4.Definir si un numero es primo");
				Console.WriteLine("5.Ordenar en forma ascendente los vectores");
				Console.WriteLine("6.Definir si existe o no un dato");
				Console.WriteLine("7.Buscar el numero mayor y menor");
				Console.WriteLine("8.Definir si es palindromo o no");
				Console.WriteLine("9.Mostrar la serie del algoritmo de Fibonacci");
				Console.WriteLine("10.Calcular parafiscales");
